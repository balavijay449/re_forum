		...
		<div class="sub-root d-flex justify-content-center align-items-center flex-column">
			...
			<div >
				<form class="content-root" autocomplete="off" method="post" id="form" name="form">
					<input type="text" class="reg-no" placeholder="Staff ID" id="reg_no" name="reg_no">			
					<p class="explain-text" id="reg_no_text">Enter staff id*</p>
					...
					<a href="faculty_register.php" class="create">Create an new account</a>
				</form>			
			</div>
		</div>		
	</div>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>	
	<script src="../js/faculty_conformation.js"></script>
